  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        Text('Amr Nossohy',style: AppTextStyles.poppinsSemiBold20Blue,),
        Text('Football',style: AppTextStyles.poppinsRegular14Black,),
        ...
        const Row(
          ...
          children: [
            ...
            SizedBox(width: 5,),
            Text('Cairo',style: TextStyle(color: Colors.black54,fontSize: 16),)
          ],
        ),
        const SizedBox(height: 4,),
        Text('Reviews: 1K',style: AppTextStyles.poppinsBold22Black,),
        const SizedBox(height: 20,),
        LinksContainer(),
      ],
    );
